...
public class Employee {
	...
	public Employee(
			...
			@Pattern(regexp = "[1-9][0-9]{9}", message = "Mobile number is expected to be 10 digits not string") @NotNull(message = "Mobile Number can not be omitted.") String mobileNumber,
